...
public class AirAMapMarker extends AirAMapFeature {
    ...
    private AirAMapCallout calloutView;
    ...
    public AirAMapMarker(Context context) {
        super(context);
    ...
    public void setCalloutView(AirAMapCallout view) {
        this.calloutView = view;
        this.title = "";
    }

    public AirAMapCallout getCalloutView() {
