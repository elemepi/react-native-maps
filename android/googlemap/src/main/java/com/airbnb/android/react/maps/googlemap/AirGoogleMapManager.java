...
public class AirGoogleMapManager extends ViewGroupManager<AirGoogleMapView> {
    ...
    @Override
    public void receiveCommand(AirGoogleMapView view, int commandId, @Nullable ReadableArray args) {
        Integer duration;
        Double lat;
        Double lng;
        Double lngDelta;
