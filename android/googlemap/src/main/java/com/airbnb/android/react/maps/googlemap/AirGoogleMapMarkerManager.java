...
public class AirGoogleMapMarkerManager extends ViewGroupManager<AirGoogleMapMarker> {

    private static final int SHOW_INFO_WINDOW = 1;
    private static final int HIDE_INFO_WINDOW = 2;

    public AirGoogleMapMarkerManager() {
    }

    @Override
    public String getName() {
        return "AIRGoogleMapMarker";
    }

    @Override
    public AirGoogleMapMarker createViewInstance(ThemedReactContext context) {
        return new AirGoogleMapMarker(context);
    }

    @ReactProp(name = "coordinate")
    public void setCoordinate(AirGoogleMapMarker view, ReadableMap map) {
        view.setCoordinate(map);
    }

    @ReactProp(name = "title")
    public void setTitle(AirGoogleMapMarker view, String title) {
        view.setTitle(title);
    }

    @ReactProp(name = "identifier")
    public void setIdentifier(AirGoogleMapMarker view, String identifier) {
        view.setIdentifier(identifier);
    }

    @ReactProp(name = "description")
    public void setDescription(AirGoogleMapMarker view, String description) {
...
//    }
    ...
    public void setAnchor(AirGoogleMapMarker view, ReadableMap map) {
    ...
    public void setCalloutAnchor(AirGoogleMapMarker view, ReadableMap map) {
    ...
    public void setImage(AirGoogleMapMarker view, @Nullable String source) {
...
//    }
    ...
    public void setPinColor(AirGoogleMapMarker view, int pinColor) {
    ...
    public void setMarkerRotation(AirGoogleMapMarker view, float rotation) {
        view.setRotation(rotation);
    }

    @ReactProp(name = "flat", defaultBoolean = false)
    public void setFlat(AirGoogleMapMarker view, boolean flat) {
        view.setFlat(flat);
    }

    @ReactProp(name = "draggable", defaultBoolean = false)
    public void setDraggable(AirGoogleMapMarker view, boolean draggable) {
        view.setDraggable(draggable);
    }

    @Override
    @ReactProp(name = "zIndex", defaultFloat = 0.0f)
    public void setZIndex(AirGoogleMapMarker view, float zIndex) {
    ...
    public void setOpacity(AirGoogleMapMarker view, float opacity) {
      super.setOpacity(view, opacity);
      view.setOpacity(opacity);
    }

    @Override
    public void addView(AirGoogleMapMarker parent, View child, int index) {
        // if an <Callout /> component is a child, then it is a callout view, NOT part of the
        // marker.
        if (child instanceof AirGoogleMapCallout) {
            parent.setCalloutView((AirGoogleMapCallout) child);
        } else {
    ...
    @Override
    public void removeViewAt(AirGoogleMapMarker parent, int index) {
    ...
    @Override
    public void receiveCommand(AirGoogleMapMarker view, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
    ...
    @Override
    public void updateExtraData(AirGoogleMapMarker view, Object extraData) {
