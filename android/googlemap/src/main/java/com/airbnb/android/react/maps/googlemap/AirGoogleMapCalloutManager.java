...
public class AirGoogleMapCalloutManager extends ViewGroupManager<AirGoogleMapCallout> {

    @Override
    public String getName() {
        return "AIRGoogleMapCallout";
    }

    @Override
    public AirGoogleMapCallout createViewInstance(ThemedReactContext context) {
        return new AirGoogleMapCallout(context);
    }

    @ReactProp(name = "tooltip", defaultBoolean = false)
    public void setTooltip(AirGoogleMapCallout view, boolean tooltip) {
    ...
    @Override
    public void updateExtraData(AirGoogleMapCallout view, Object extraData) {
