...
public class AirGoogleMapMarker extends AirMapFeature<GoogleMap> {
    ...
    private AirGoogleMapCallout calloutView;
    ...
    public AirGoogleMapMarker(Context context) {
        super(context);
    ...
    public void setCalloutView(AirGoogleMapCallout view) {
        this.calloutView = view;
    }

    public AirGoogleMapCallout getCalloutView() {
